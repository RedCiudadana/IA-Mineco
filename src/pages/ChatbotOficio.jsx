...
Contexto: MINECO busca establecer una alianza con una universidad para fortalecer la planificación territorial.
📝 Prompt:
*"Redacta una carta formal en nombre de MINECO dirigida al rector de una universidad, solicitando cooperación técnica en planificación territorial. La carta debe incluir:
1. Saludo formal y presentación de MINECO como entidad rectora de la planificación en Guatemala.
...
Contexto: MINECO implementará nuevos procedimientos administrativos internos y necesita informar a su personal.
📝 Prompt:
*"Genera un memorando interno para todos los funcionarios de MINECO informando sobre el cambio en procedimientos administrativos.
Debe incluir:
...
Contexto: MINECO debe presentar un informe de avances sobre un proyecto de planificación urbana financiado por cooperación internacional.
📝 Prompt:
*"Escribe un informe ejecutivo sobre los avances del proyecto de planificación urbana que MINECO está ejecutando con financiamiento de cooperación internacional.
...
Debe mantener un tono técnico, claro y enfocado en resultados medibles."*,`,
        ...
        `Solicitud de Presupuesto para un Evento de MINECO

Contexto: MINECO necesita solicitar presupuesto para un evento sobre transformación digital en la administración pública.
📝 Prompt:
*"Redacta una solicitud de presupuesto dirigida al departamento financiero de MINECO para la organización del evento “Transformación Digital en la Administración Pública”.
Debe incluir:
...
Contexto: Un ciudadano ha solicitado información sobre los proyectos de planificación territorial en su municipio. MINECO debe responder formalmente.
📝 Prompt:
*"Escribe una respuesta oficial a una consulta ciudadana recibida en MINECO sobre proyectos de planificación territorial en un municipio específico.
Debe incluir:
1. Saludo formal y agradecimiento por la consulta.
2. Explicación del marco general de planificación territorial y el rol de MINECO en este proceso.
    ...
    <>
      ...
      <div className="main-center-content-m-left-2 center-content search-sticky">
        {isVisible && (
          ...
          🌟 <b>¡Bienvenido al módulo de Asistentes Virtuales de IA de MINECO!</b> 🌟
              <br/>
