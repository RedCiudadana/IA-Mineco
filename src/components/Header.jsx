          ...
          <div className="col-lg-12 my-4">
            <div className="header-inner-one">
              ...
              <div className="left-logo-area">
                <Link to="/">
                  <img style={{marginLeft:'10px',width:'200px'}} src="/assets/images/mineco/02_LOGOS/IA_MINECO-02.png" alt="logo-image" />
                </Link>
                <button
              ...
              <div className="header-right">
                ...
                <div className="action-interactive-area__header">
                  ...
                  <div className="single_action__haeader user_avatar__information openuptip" flow="down" tooltip="Perfil">
                    <div className="avatar">
                      <img  src="/assets/images/mineco/01_IMAGENES/IA_MINECO-04.png" style={{ width: '50px' }} alt="avatar" />
                    </div>
                    <div className="user_information_main_wrapper slide-down__click">
                      <div className="user_header">
                        <div className="main-avatar">
                          <img src="/assets/images/congreso/01_IMAGENES/IA_CONGRESO-04.png" alt="user" />
                        </div>
